  ...
  <xsl:template match=""/s0:Records"">
    <NewDataSet>
      <xsl:for-each select=""s0:row"">
        ...
        private const global::BizTalk_Server_Project1.LOT_SHIPPING _srcSchemaTypeReference0 = null;
        
        private const string _strTrgSchemasList0 = @"BizTalk_Server_Project1.dataset";
        
        private const global::BizTalk_Server_Project1.dataset _trgSchemaTypeReference0 = null;
